...
#ifndef WRP_CAE_CORE_OPERATOR_SCHEDULER_H_
#define WRP_CAE_CORE_OPERATOR_SCHEDULER_H_
...
class OperatorScheduler {
 public:
   ...
   */
  OperatorScheduler(std::shared_ptr<wrp_cte::core::Client> cte_client,
...
#endif  // WRP_CAE_CORE_OPERATOR_SCHEDULER_H_
